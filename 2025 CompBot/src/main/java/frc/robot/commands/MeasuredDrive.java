...
public class MeasuredDrive extends Command {
  ...
  */
  ...
  public void initialize() {
    ...
    controller = new PIDController(.5/targetDistance/targetDistance, 0.,0.);
  }
  ...
  public void execute() {
    ...
    double mag = controller.calculate(drivenDistance*drivenDistance, targetDistance);
  ...
  public boolean isFinished() {
    return Math.abs(targetDistance-drivenDistance)<CLOSE_ENOUGH;
  }
}
